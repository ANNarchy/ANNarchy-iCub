...
def create_robot_interface_file(filename_config, filename_interface="./robot_interface.py"):
    """
        ...
        params:
            string filename_config      -- filename of XML config file
            string filename_interface   -- filename of created interface file
    """
