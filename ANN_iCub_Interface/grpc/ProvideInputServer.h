...
#include "ANN_iCub_Interface/grpc/icub.grpc.pb.h"
#include "ANN_iCub_Interface/grpc/icub.pb.h"
#include "ANN_iCub_Interface/include/Module_Base_Class.hpp"
...
class ProvideInputServiceImpl final : public iCubInterfaceMessages::ProvideInput::Service {
    ...
    // grpc::Status RetrieveImage(grpc::ServerContext *context, const iCubInterfaceMessages::ImageRequest *request,
    //                            iCubInterfaceMessages::RgbImageResponse *response) override {
    //     auto image = interface_instance->provideData();
    //     google::protobuf::RepeatedField<uint8_t> data(image.begin(), image.end());
    //     response->mutable_imagel()->Swap(&data);
    //     return grpc::Status::OK;
    // }
